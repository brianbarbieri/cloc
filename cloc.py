...
def visualize_info(info_dict):
    ...
    print("-------------------------------------------------------------------------------")
    print(f"{'Extension':20} {'# of files':20} {'# of lines':20} {'# of empty lines':20}")
    print("-------------------------------------------------------------------------------")
    for ext, data in sorted_info:
        print(f"{ext:20} {data['# of files']:<20} {data['line_count']:<20} {data['empty_lines']:<20}")
    print("-------------------------------------------------------------------------------")
    print(f"{'Sum:':20} {total_files:<20} {total_line_count:<20} {total_empty_lines:<20}")
    print("-------------------------------------------------------------------------------")
